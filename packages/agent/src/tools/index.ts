/** HITL tools have NO `execute`: the loop pauses and the web sends the user's
 * answer back as the tool output. Research runs through Exa; the Manim tools
 * are present only when a sandbox is provided. */
