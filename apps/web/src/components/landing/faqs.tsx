			...
			<div className="pb-8 md:pr-8 md:pb-0">
				<div className="space-y-5">
					...
					<p className="text-muted-foreground">
						The short version of how anima works. Open any question for more.
					</p>
					<p className="text-muted-foreground">
						{"Still curious? "}
...
const faqs = [
	{
		id: "item-1",
		title: "What exactly does anima produce?",
		content:
			"A narrated, animated explainer video. anima researches your topic, plans the scenes, animates them with Manim, and adds a synced voiceover — you get a finished, shareable film.",
	},
	{
		id: "item-2",
		title: "How is this different from NotebookLM or a slideshow tool?",
		content:
			"Instead of static slides or talking-head audio, anima renders real motion graphics with mathematically precise visuals, and every claim is grounded in sources it actually read.",
	},
	{
		id: "item-3",
		title: "Do I need to know Manim or write any code?",
		content:
			"No. anima writes and runs the Manim code for you inside a sandbox. If you do know Manim, you can review and steer the storyboard before it renders.",
	},
	{
		id: "item-4",
		title: "Can I edit the storyboard before it renders?",
		content:
			"Yes. anima shows you the scene-by-scene plan with narration first. You can reorder, rewrite, or cut scenes before committing to a full render.",
	},
	{
		id: "item-5",
	...
	},
	{
		...
		content:
			"anima watches its own output. When a scene has a layout, timing, or code error, it diagnoses and repairs it automatically before handing you the result.",
	},
];
