...
function VideoHero({
  ...
  return (
    ...
    >
      <div
        aria-hidden="true"
        className="absolute -inset-6 -z-10 rounded-[2rem] bg-[radial-gradient(ellipse_at_center,theme(--color-primary/.25),transparent_70%)] blur-2xl"
      />
        ...
        {state.status === "ready" ? (
          <div className="mx-auto grid w-full max-w-360 items-center gap-10 lg:grid-cols-[minmax(0,5fr)_minmax(0,7fr)] lg:gap-16">
            <div className="flex flex-col items-center gap-7 text-center lg:items-start lg:text-left">
              ...
              <p
                className={cn(
                  "max-w-lg text-balance text-lg text-muted-foreground md:text-xl",
